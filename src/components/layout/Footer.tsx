      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: "#777" }}>
              <li><a href="https://store.steampowered.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#3388BB] transition-colors">Steam 主页</a></li>
              <li><a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#3388BB] transition-colors">GitHub 组织</a></li>
              <li><a href="https://itch.io" target="_blank" rel="noopener noreferrer" className="hover:text-[#3388BB] transition-colors">Itch.io 主页</a></li>
            </ul>
          </div>
        </div>
        <div className="mt-8 pt-6 border-t flex flex-col md:flex-row justify-between items-center gap-3" style={{ borderColor: "#D0DEE8" }}>
