...
export default function BackupsPage() {
  ...
  return (
    <div style={{ color: "#333" }}>
      ...
      {msg && (
        <div className={`mb-4 p-3 rounded-md text-sm ${msg.includes("失败") || msg.includes("错误") ? "bg-red-50 border border-red-200 text-red-600" : "bg-green-50 border border-green-200 text-green-700"}`}>
          {msg}
        </div>
      )}
